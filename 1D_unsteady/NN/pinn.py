...
class PINN(Model):
    def __init__(self, nhl, npl, act):
        ...
        #Collocation points
        self.xc = np.round(np.linspace(0,1,10001),4)
        self.tc = np.round(np.linspace(0,1,10001),4)

        self.uc = np.round(np.linspace(0.01,0.20,1001),4)
        ...
        self.path_wts = os.getcwd() + r"/1D_unsteady/NN/wts"
        self.path_plots = os.getcwd() + r"/1D_unsteady/NN/plots"
        self.path_data = os.getcwd() + r"/1D_unsteady/Num"
